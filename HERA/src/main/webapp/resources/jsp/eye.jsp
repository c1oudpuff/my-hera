...
<body>
  ...
  <%
    ...
    String sql = "SELECT * FROM eye WHERE code = ?";
  ...
  <div class="container my-5">
    <div class="row">
      <!-- 상품 이미지 -->
      <div class="col-md-5">
        <img src="../images/eye/<%= rs.getString("filename") %>" alt="<%= rs.getString("name") %>" class="img-fluid rounded shadow-sm"/>
      </div>
      ...
      <div class="col-md-7">
        ...
        <a href="./eyes.jsp" class="btn btn-secondary">상품 목록 &raquo;</a>
      </div>
    </div>
  </div>
