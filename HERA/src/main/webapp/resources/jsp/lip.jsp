...
<body>
  ...
  <%
    ...
    String sql = "SELECT * FROM lip WHERE code = ?";
  ...
  <div class="container my-5">
    <div class="row">
      <!-- 상품 이미지 -->
      <div class="col-md-5">
        <img src="../images/lip/<%= rs.getString("filename") %>" alt="<%= rs.getString("name") %>" class="img-fluid rounded shadow-sm"/>
      </div>
      ...
      <div class="col-md-7">
        ...
        <!-- 주문 및 목록 버튼 -->
        <a href="#" class="btn btn-primary">상품 주문 &raquo;</a>
        <a href="./lips.jsp" class="btn btn-secondary">상품 목록 &raquo;</a>
      </div>
    </div>
  </div>
