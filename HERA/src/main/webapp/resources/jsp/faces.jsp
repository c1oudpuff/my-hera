...
<body>
    ...
    <div class="container-fluid p-0 mb-5">
        <div class="row">
            <div class="col-12">
                <img src="../images/face_banner.jpg" alt="" class="img-fluid" />
            </div>
        </div>
    </div>
...
<div class="container mb-5">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4">
            <img src="../images/face/<%= rs.getString("filename") %>" alt="" class="img-fluid" />
            <h5><%= rs.getString("name") %></h5>
            <p><%= rs.getString("description") %></p>
            <p><%= formatter.format(rs.getInt("price")) %>원</p>
            <p><a href="./face.jsp?code=<%= rs.getString("code") %>" class="btn">상세 정보 &raquo;</a></p>
        </div>
        <%
            }
        %>
